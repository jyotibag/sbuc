...
const ProductDetails = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Link to="/shop" className="inline-flex items-center text-teal-600 hover:text-teal-700 mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        ...
        <div>
          ...
          {product.is_santiniketan && (
            <span className="inline-block bg-teal-500 text-white px-3 py-1 rounded-full text-sm font-semibold mb-4">
              Santiniketan Handmade
            </span>
          )}
