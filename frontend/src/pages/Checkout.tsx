...
const Checkout = () => {
  ...
  return (
    <div>
      <PageHeader
        title="Checkout"
        subtitle="Complete your purchase with a smooth, secure experience."
      />
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card p-6">
              ...
              <div className="space-y-4">
                <label className="flex items-center p-4 border-2 rounded-2xl cursor-pointer hover:border-teal-500 transition-colors">
                  <input
                    type="radio"
                    name="payment"
                    value="cod"
                    ...
                    className="mr-4"
                  />
                  <Truck className="w-6 h-6 mr-4 text-teal-700" />
                  <div>
                ...
                <label className="flex items-center p-4 border-2 rounded-2xl cursor-pointer hover:border-teal-500 transition-colors">
                  <input
                    ...
                    className="mr-4"
                  />
                  <CreditCard className="w-6 h-6 mr-4 text-teal-700" />
                  <div>
